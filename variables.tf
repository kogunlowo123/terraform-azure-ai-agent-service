...
variable "allowed_ip_ranges" {
  description = "List of IP CIDR ranges allowed to access the OpenAI service (when network rules are configured)"
  type        = list(string)
  default     = []
}
...
variable "virtual_network_id" {
  description = "ID of the virtual network for private endpoints (required if enable_private_endpoints is true)"
  type        = string
  default     = ""
}

variable "private_endpoint_subnet_id" {
  description = "ID of the subnet for private endpoints (required if enable_private_endpoints is true)"
  type        = string
  default     = ""
}
