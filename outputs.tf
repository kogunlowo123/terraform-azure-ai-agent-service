...
output "application_insights_id" {
  description = "The resource ID of Application Insights (if monitoring is enabled)"
...
output "application_insights_connection_string" {
  description = "The connection string for Application Insights (if monitoring is enabled)"
